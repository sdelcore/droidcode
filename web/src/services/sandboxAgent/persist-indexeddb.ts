...
// https://raw.githubusercontent.com/rivet-dev/sandbox-agent/main/frontend/packages/inspector/src/persist-indexeddb.ts
// See wagent/docs/droidcode-migration.md §2 — the SDK docs explicitly
// recommend copying this driver rather than subclassing the SDK.
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onupgradeneeded = () => {
        ...
        if (!db.objectStoreNames.contains(EVENTS_STORE)) {
          ...
          events.createIndex(
            EVENTS_BY_SESSION_INDEX,
            ['sessionId', 'eventIndex', 'id'],
            { unique: false },
          )
        } else {
